          ...
          <div className="xs:bottom-20 w-full flex justify-start lg:pb-1 pb-16 lg:pt-16 pt-8 items-center flex-col">
            ...
            <div className="flex justify-center gap-4 lg:flex-col-reverse sm:flex-row" >
              <div className="flex justify-center gap-4">
                <a href="#projects">
                  <div
                    className="px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform text-center hover:-translate-y-1"
                  >
                    Scroll Projects
                  </div>
                </a>
                <a
                  href="#contact"
                >
                  <div className="px-6 py-3 bg-white text-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform text-center hover:-translate-y-1 border border-gray-100">
                    Contact Me
                  </div>
                </a>
              </div>
              ...
              <div className="text-lg lg:block hidden md:text-xl text-white mb-6 text-center animate-fade-in-delay">
